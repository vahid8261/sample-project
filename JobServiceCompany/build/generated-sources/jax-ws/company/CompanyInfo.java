...
public interface CompanyInfo {
    ...
    @RequestWrapper(localName = "getCompanyInfo", targetNamespace = "http://services/", className = "company.GetCompanyInfo")
    @ResponseWrapper(localName = "getCompanyInfoResponse", targetNamespace = "http://services/", className = "company.GetCompanyInfoResponse")
